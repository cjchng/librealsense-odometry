...
// Change in line 7-8 @yash 467change 469-470@shiv
//Editedcode-- shivani-raghav 
// here code will open camera shows movement of camera via trajectory and print matrix.txt file in folder. (need to make empyty matrix.txt file)
#include <librealsense2/rs.hpp>
#include "example.hpp"          // Include short list of convenience functions for rendering
#include <cstring>
#include <iostream> // extra added 
#include <fstream>  // extra added 
struct short3
{
    uint16_t x, y, z;
};
...
public:
	...
	//for (int i =0 ;i<15 ;i++)
	//{
	//std::cout<<mat[i] << "two" << std::endl; //mat print
	//}
...
int main(int argc, char * argv[]) try
{
    ...
    // Add pose stream
     ...
     //cfg.enable_record_to_file("ab1.bag"); //@shivani edit
     //cfg.enable_device_from_file("/home/raghav/Documents/librealsense-2.31.0/build/examples/trajectory/mybag.bag");
     cfg.enable_stream(RS2_STREAM_POSE, RS2_FORMAT_6DOF); //
    // Start pipeline with chosen configuration
    pipe.start(cfg);
   

    std::ofstream myfile("/home/raghav/Desktop/librealsense-2.31.0/build/examples/trajectory/matrix.txt"); // yash@edit
 ...
 while (app)
	...
	//std::cerr<<pose_data<<"Pose Data'\n'"; //print pose data
	

         float r[16]; // r is matrix , single array
        // Calculate current transformation matrix
        tracker.calc_transform(pose_data, r);
// first time change to code for loop 489-492
	//for (int i =0 ;i<15 ;i++)
	//{
	//std::cout<<r[i] <<" one "<< std::endl; //mat print
	//}
// second time change - new_addition 472,496-506,518
