...
//Edited code Raghav-Shivani 
// Here we give path of a recorded bag file (instead of camera) generated matrix.txt file (Keep in mind to make empty matrix.txt file)
...
int main(int argc, char * argv[]) try
{
    ...
    // Add pose stream
     ...
     cfg.enable_device_from_file("/home/raghav/Desktop/Bag-files/mybag.bag");
